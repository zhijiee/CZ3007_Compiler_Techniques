...
*	[A-Za-z0-9_]* 	---> 0 or more of letters, digits or underscore. 
*/
...
*
*   (		---> Start of Group   
*	\\.		---> Literal of any character
*	|		---> OR 
*	[^\"]	---> Inverted character class. Any character except "
*	)* 		---> 0 to many of matched group
*	
*	\" 		---> End with "
*/
StringLiteral = \"(\\.|[^\"])*\"
...
//Identifier Sequence of 1 or more characters
{Identifier}		{ return token(ID); }

//2 kind of literals, String and Integer literals
{IntegerLiteral}	{ return token(INT_LITERAL); }
{StringLiteral} 	{ return token(STRING_LITERAL,yytext()); }

//White space do not need to handle them
{WhiteSpace}+		{ }
